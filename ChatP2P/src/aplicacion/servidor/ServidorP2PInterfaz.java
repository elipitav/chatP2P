...
public interface ServidorP2PInterfaz extends Remote {
    ...
    public ArrayList<String> obtenerSolicitudes(String usuarioReceptor, String contrasena) throws java.rmi.RemoteException;
    ...
    public void rechazarAmistad(String emisor, String receptor, String contrasena) throws java.rmi.RemoteException;
}
